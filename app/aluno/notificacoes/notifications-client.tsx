...
import { Bell, CheckCircle2, ChevronRight, MessageSquare, Dumbbell, User, TrendingUp } from "lucide-react";
...
import { markStudentNotificationAsReadAction } from "./actions";
...
export default function NotificationsClient({ notifications }: { notifications: StudentNotification[] }) {
  ...
  const handleNotificationClick = async (notification: StudentNotification) => {
    if (!notification.read_at) {
      ...
      await markStudentNotificationAsReadAction(formData);
    }
  };
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-2 max-w-xl text-slate-300">
          Acompanhe atualizacoes, respostas de suporte e avisos importantes.
        </p>
      </div>
